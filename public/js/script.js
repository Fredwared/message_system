...
window.onload = function() {
	...
	//4. 电子邮件控件的校验
	document.getElementById('emailTip').onblur = function() {
		//4.1 先获得用户输入的数据
	...
	/*document.getElementById('captchaImg').onclick = function() {
		//修改验证码图片
		this.src = "/home/users/captcha/atype/register/" ;
	};*/
...
function changeCaptcha(){
	...
	captchaImg.src = "/home/users/captcha/atype/register/";
}
